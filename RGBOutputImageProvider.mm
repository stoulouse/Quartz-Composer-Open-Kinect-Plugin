	...
	if (format == QCPlugInPixelFormatARGB8) {
		...
		for (int i = 0; i < bounds.size.height; ++i) {
			for (int j = 0; j < bounds.size.width; ++j) {
				...
				buf[j * 4 + i * (int)bounds.size.width * 4 + 1] = _plugin->_rgb_back[j * 3 + i * (int)bounds.size.width * 3 + 0];
				buf[j * 4 + i * (int)bounds.size.width * 4 + 2] = _plugin->_rgb_back[j * 3 + i * (int)bounds.size.width * 3 + 1];
				buf[j * 4 + i * (int)bounds.size.width * 4 + 3] = _plugin->_rgb_back[j * 3 + i * (int)bounds.size.width * 3 + 2];
			}
		}
		...
		for (int i = 0; i < bounds.size.height; ++i) {
			for (int j = 0; j < bounds.size.width; ++j) {
				buf[j * 4 + i * (int)bounds.size.width * 4 + 0] = _plugin->_rgb_back[j * 3 + i * (int)bounds.size.width * 3 + 2];
				buf[j * 4 + i * (int)bounds.size.width * 4 + 1] = _plugin->_rgb_back[j * 3 + i * (int)bounds.size.width * 3 + 1];
				buf[j * 4 + i * (int)bounds.size.width * 4 + 2] = _plugin->_rgb_back[j * 3 + i * (int)bounds.size.width * 3 + 0];
